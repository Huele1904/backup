    ...
    try:
        ...
        send_email(
            subject="Backup thành công",
                body=f"Thông báo backup thành công vào lúc {now}.\n đc lưu tên: {backup_file}"
        )
    except Exception as e:
        print(f"Backup thất bại: {e}")
        send_email(
            subject="Backup thất bại",
            body=f"Thông báo backup thất bại:\n{e}"
        )

schedule.every().day.at("00:00").do(backup_database)

print("Thông báo sẽ được gửi vào lúc 12:00 AM")
